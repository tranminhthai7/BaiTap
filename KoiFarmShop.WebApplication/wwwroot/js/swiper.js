...
!function(e, t) {
                ...
                for (var d = o[l], p = 0; p < this.length; p += 1) {
                    ...
                    c && c.length)
                        for (var v = c.length - 1; v >= 0; v -= 1) {
                            var f = c[v];
                            s && f.listener === s || s && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === s ? (u.removeEventListener(d, f.proxyListener, n),
                            c.splice(v, 1)) : s || (u.removeEventListener(d, f.proxyListener, n),
                            c.splice(v, 1))
                        }
                }
            return this
    ...
    function S(e, t) {
        ...
        r = new s.WebKitCSSMatrix("none" === a ? "" : a)) : i = (r = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], i = 1; i < arguments.length; i += 1) {
            ...
            if (null != a)
                for (var r = Object.keys(Object(a)).filter((function(e) {
                    ...
                    void 0 !== l && l.enumerable && (x(e[o]) && x(a[o]) ? a[o].__swiper__ ? e[o] = a[o] : E(e[o], a[o]) : !x(e[o]) && x(a[o]) ? (e[o] = {},
                    a[o].__swiper__ ? e[o] = a[o] : E(e[o], a[o])) : e[o] = a[o])
                }
        }
        return e
    }
    ...
    function L(e) {
        ...
        b || (b = function(e) {
            var t = (void 0 === e ? {} : e).userAgent
              ...
              , f = "Win32" === r
              , h = "MacIntel" === r;
            return !u && h && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((u = s.match(/(Version)\/([\d.]+)/)) || (u = [0, 1, "13_0_0"]),
            h = !1),
            p && !f && (n.os = "android",
            n.android = !0),
            (u || v || c) && (n.os = "ios",
                        ...
                        e && !e.destroyed && e.initialized && (e.resize.observer = new ResizeObserver((function(t) {
                            ...
                            t.forEach((function(t) {
                                var i = t.contentBoxSize
                                  , a = t.contentRect
                                  , n = t.target;
                                n && n !== e.el || (r = a ? a.width : (i[0] || i).inlineSize,
                        ...
                        if (!r.isTouched || !r.isMoved)
                            ...
                            n.noSwiping && p.closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                                ...
                                "touchstart" !== d.type) {
                                    ...
                                    i.activeElement && m(i.activeElement).is(r.formElements) && i.activeElement !== p[0] && i.activeElement.blur();
                    ...
                    !(l.targetTouches && l.targetTouches.length > 1)) {
                        ...
                        if (!(i.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(v, 2)) < i.params.threshold)) {
                            ...
                            if (void 0 === a.isScrolling)
                                i.isHorizontal() && n.currentY === n.startY || i.isVertical() && n.currentX === n.startX ? a.isScrolling = !1 : c * c + v * v >= 25 && (f = 180 * Math.atan2(Math.abs(v), Math.abs(c)) / Math.PI,
                                a.isScrolling = i.isHorizontal() ? f > r.touchAngle : 90 - f > r.touchAngle);
                            if (a.isScrolling && i.emit("touchMoveOpposite", l),
                            ...
                            a.isScrolling)
                                ...
                                h > 0 && a.currentTranslate > i.minTranslate() ? (g = !1,
                                r.resistance && (a.currentTranslate = i.minTranslate() - 1 + Math.pow(-i.minTranslate() + a.startTranslate + h, b))) : h < 0 && a.currentTranslate < i.maxTranslate() && (g = !1,
                                r.resistance && (a.currentTranslate = i.maxTranslate() + 1 - Math.pow(i.maxTranslate() - a.startTranslate - h, b))),
    ...
    function $(e) {
        ...
        if (t.enabled) {
            ...
            var p, u = T(), c = u - i.touchStartTime;
                ...
                if (a.freeMode) {
                    ...
                    if (a.freeModeMomentum) {
                        ...
                        var g = 1e3 * a.freeModeMomentumRatio
                          ...
                          , y = t.translate + b;
                        s && (y = -y);
                        var C, S, x = !1, E = 20 * Math.abs(t.velocity) * a.freeModeMomentumBounceRatio;
                        if (y < t.maxTranslate())
                            a.freeModeMomentumBounce ? (y + t.maxTranslate() < -E && (y = t.maxTranslate() - E),
                            C = t.maxTranslate(),
                            x = !0,
                            i.allowMomentumBounce = !0) : y = t.maxTranslate(),
                            a.loop && a.centeredSlides && (S = !0);
                        else if (y > t.minTranslate())
                            a.freeModeMomentumBounce ? (y - t.minTranslate() > E && (y = t.minTranslate() + E),
                            C = t.minTranslate(),
                            x = !0,
                        ...
                        a.freeModeMomentumBounce && x ? (t.updateProgress(C),
                        t.setTransition(g),
                        t.setTranslate(y),
                    ...
                    for (var z = 0, O = t.slidesSizesGrid[0], I = 0; I < o.length; I += I < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                        ...
                        void 0 !== o[I + A] ? p >= o[I] && p < o[I + A] && (z = I,
                        O = o[I + A] - o[I]) : p >= o[I] && (z = I,
                    ...
                    if (c > a.longSwipesMs) {
                        if (!a.longSwipes)
                            return void t.slideTo(t.activeIndex);
                        "next" === t.swipeDirection && (B >= a.longSwipesRatio ? t.slideTo(z + D) : t.slideTo(z)),
                        "prev" === t.swipeDirection && (B > 1 - a.longSwipesRatio ? t.slideTo(z + D) : t.slideTo(z))
                    } else {
                        if (!a.shortSwipes)
                            return void t.slideTo(t.activeIndex);
      ...
      , j = {
        ...
        eventsEmitter: {
            ...
            onAny: function(e, t) {
                ...
                return i.eventsAnyListeners.indexOf(e) < 0 && i.eventsAnyListeners[a](e),
                i
            },
            offAny: function(e) {
                var t = this;
        ...
        update: {
            updateSize: function() {
                ...
                0 === e && i.isHorizontal() || 0 === t && i.isVertical() || (e = e - parseInt(a.css("padding-left") || 0, 10) - parseInt(a.css("padding-right") || 0, 10),
            ...
            updateSlides: function() {
                ...
                if (void 0 !== s) {
                    ...
                    a.slidesPerColumn > 1 && (S = Math.floor(u / a.slidesPerColumn) === u / e.params.slidesPerColumn ? u : Math.ceil(u / a.slidesPerColumn) * a.slidesPerColumn,
                    "auto" !== a.slidesPerView && "row" === a.slidesPerColumnFill && (S = Math.max(S, a.slidesPerView * a.slidesPerColumn)));
                    for (var M, P, k, L = a.slidesPerColumn, z = S / L, O = Math.floor(u / a.slidesPerColumn), I = 0; I < u; I += 1) {
                        ...
                        if (a.slidesPerColumn > 1) {
                            ...
                            if ("row" === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                                ...
                                "column" === a.slidesPerColumnFill ? ($ = I - (D = Math.floor(I / L)) * L,
                                (D > O || D === O && $ === L - 1) && ($ += 1) >= L && ($ = 0,
                                D += 1)) : D = I - ($ = Math.floor(I / z)) * z;
                        ...
                        if ("none" !== A.css("display")) {
                            ...
                            f.push(x),
                            a.centeredSlides ? (C = C + x / 2 + w / 2 + y,
                            0 === w && 0 !== I && (C = C - s / 2 - y),
                            0 === I && (C = C - s / 2 - y),
                            Math.abs(C) < .001 && (C = 0),
                            a.roundLengths && (C = Math.floor(C)),
                            T % a.slidesPerGroup == 0 && c.push(C),
                            v.push(C)) : (a.roundLengths && (C = Math.floor(C)),
                            (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && c.push(C),
                            v.push(C),
                            C = C + x + y),
                            e.virtualSize += x + y,
                            w = x,
                    ...
                    a.setWrapperSize)
                        r.css(((P = {})[t("width")] = e.virtualSize + a.spaceBetween + "px",
                        P));
                    if (a.slidesPerColumn > 1)
                        if (e.virtualSize = (x + a.spaceBetween) * S,
                        e.virtualSize = Math.ceil(e.virtualSize / a.slidesPerColumn) - a.spaceBetween,
                        r.css(((k = {})[t("width")] = e.virtualSize + a.spaceBetween + "px",
                        k)),
                        a.centeredSlides) {
                            M = [];
            ...
            updateAutoHeight: function(e) {
                var t, i = this, a = [], r = i.virtual && i.params.virtual.enabled, s = 0;
            ...
            updateSlidesClasses: function() {
                var e, t = this, i = t.slides, a = t.params, r = t.$wrapperEl, s = t.activeIndex, n = t.realIndex, o = t.virtual && a.virtual.enabled;
                ...
                (e = o ? t.$wrapperEl.find("." + a.slideClass + '[data-swiper-slide-index="' + s + '"]') : i.eq(s)).addClass(a.slideActiveClass),
                a.loop && (e.hasClass(a.slideDuplicateClass) ? r.children("." + a.slideClass + ":not(." + a.slideDuplicateClass + ')[data-swiper-slide-index="' + n + '"]').addClass(a.slideDuplicateActiveClass) : r.children("." + a.slideClass + "." + a.slideDuplicateClass + '[data-swiper-slide-index="' + n + '"]').addClass(a.slideDuplicateActiveClass));
            ...
            updateActiveIndex: function(e) {
                var t, i = this, a = i.rtlTranslate ? i.translate : -i.translate, r = i.slidesGrid, s = i.snapGrid, n = i.params, o = i.activeIndex, l = i.realIndex, d = i.snapIndex, p = e;
                if (void 0 === p) {
                    for (var u = 0; u < r.length; u += 1)
                        void 0 !== r[u + 1] ? a >= r[u] && a < r[u + 1] - (r[u + 1] - r[u]) / 2 ? p = u : a >= r[u] && a < r[u + 1] && (p = u + 1) : a >= r[u] && (p = u);
            ...
            updateClickedSlide: function(e) {
                var t, i = this, a = i.params, r = m(e.target).closest("." + a.slideClass)[0], s = !1;
                if (r)
        ...
        translate: {
            ...
            setTranslate: function(e, t) {
                ...
                d = Math.floor(d)),
                r.cssMode ? n[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -d : r.virtualTranslate || s.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
        ...
        slide: {
            slideTo: function(e, t, i, a, r) {
                ...
                var l = n.params
                  ...
                  , f = n.wrapperEl
                  , h = n.enabled;
                if (n.animating && l.preventInteractionOnTransition || !h && !a && !r)
                    return !1;
            ...
            slideToClickedSlide: function() {
                var e, t = this, i = t.params, a = t.$wrapperEl, r = "auto" === i.slidesPerView ? t.slidesPerViewDynamic() : i.slidesPerView, s = t.clickedIndex;
                if (i.loop) {
                    if (t.animating)
                        return;
                    e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10),
                    i.centeredSlides ? s < t.loopedSlides - r / 2 || s > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(),
                    s = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(),
                    w((function() {
                        t.slideTo(s)
                    }
        ...
        loop: {
            ...
            loopFix: function() {
                ...
                var t, i = e.activeIndex, a = e.slides, r = e.loopedSlides, s = e.allowSlidePrev, n = e.allowSlideNext, o = e.snapGrid, l = e.rtlTranslate;
                e.allowSlidePrev = !0,
                e.allowSlideNext = !0;
        ...
        events: {
            attachEvents: function() {
                ...
                if (!l.touch && l.pointerEvents)
                    ...
                    if (l.touch) {
                        ...
                        V || (t.addEventListener("touchstart", _),
                        V = !0)
                    }
                    (i.simulateTouch && !o.ios && !o.android || i.simulateTouch && !l.touch && o.ios) && (r.addEventListener("mousedown", e.onTouchStart, !1),
                ...
                i.updateOnWindowResize ? e.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", G, !0) : e.on("observerUpdate", G, !0)
            },
            detachEvents: function() {
                ...
                if (!l.touch && l.pointerEvents)
                    ...
                    (i.simulateTouch && !o.ios && !o.android || i.simulateTouch && !l.touch && o.ios) && (r.removeEventListener("mousedown", e.onTouchStart, !1),
        ...
        classes: {
            addClasses: function() {
                var e, t, i, a = this, r = a.classNames, s = a.params, n = a.rtl, o = a.$el, l = a.device, d = a.support, p = (e = ["initialized", s.direction, {
      ...
      , R = function() {
        function t() {
            for (var e, i, a = arguments.length, r = new Array(a), s = 0; s < a; s++)
                r[s] = arguments[s];
            if (1 === r.length && r[0].constructor && "Object" === Object.prototype.toString.call(r[0]).slice(8, -1) ? i = r[0] : (e = r[0],
            i = r[1]),
            i || (i = {}),
            i = E({}, i),
            e && !i.el && (i.el = e),
        ...
        s.mount = function(e) {
            ...
            e && e.shadowRoot && e.shadowRoot.querySelector ? (i = m(e.shadowRoot.querySelector("." + t.params.wrapperClass))).children = function(e) {
                return a.children(e)
            }
        ...
        s.destroy = function(e, t) {
            void 0 === e && (e = !0),
            void 0 === t && (t = !0);
            var i, a = this, r = a.params, s = a.$el, n = a.$wrapperEl, o = a.slides;
    ...
    var W = {
        ...
        init: function() {
            ...
            i.enabled || (e && e.addClass(a.lockClass),
      ...
      , X = {
        update: function() {
            ...
            if (i.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                var a, r = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length, s = e.pagination.$el, n = e.params.loop ? Math.ceil((r - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length;
                if (e.params.loop ? ((a = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > r - 1 - 2 * e.loopedSlides && (a -= r - 2 * e.loopedSlides),
                a > n - 1 && (a -= n),
                a < 0 && "bullets" !== e.params.paginationType && (a = n + a)) : a = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0,
                "bullets" === i.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                    var o, l, d, p = e.pagination.bullets;
                    if (i.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    s.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"),
                    i.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += a - e.previousIndex,
                    ...
                    s.length > 1)
                        p.each((function(e) {
                            ...
                            i.dynamicBullets && (r >= o && r <= l && t.addClass(i.bulletActiveClass + "-main"),
                            r === o && t.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"),
                ...
                if ("fraction" === i.type && (s.find(P(i.currentClass)).text(i.formatFractionCurrent(a + 1)),
                ...
                "progressbar" === i.type) {
                    ...
                    s.find(P(i.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(" + S + ") scaleY(" + x + ")").transition(e.params.speed)
                }
                "custom" === i.type && i.renderCustom ? (s.html(i.renderCustom(e, a + 1, n)),
        ...
        load: function() {
            ...
            if (n.loadPrevNext)
                if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                    for (var u = n.loadPrevNextAmount, c = o, v = Math.min(r + c + Math.max(u, c), a.length), f = Math.max(r - Math.max(c, u), 0), h = r + o; h < v; h += 1)
      ...
      , U = {
        ...
        setTranslate: function(e, t) {
            var i, a, r = this, s = r.controller.control, n = r.constructor;
            function o(e) {
        ...
        setTransition: function(e, t) {
            var i, a = this, r = a.constructor, s = a.controller.control;
            function n(t) {
                t.setTransition(e, a),
        ...
        onThumbClick: function() {
            ...
            if (t) {
                ...
                if (!(a && m(a).hasClass(e.params.thumbs.slideThumbActiveClass) || null == i)) {
                    var r;
                    if (r = t.params.loop ? parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
                    e.params.loop) {
                        var s = e.activeIndex;
        ...
        update: function(e) {
            ...
            if (i) {
                ...
                if (t.realIndex !== i.realIndex || s) {
                    ...
                    s && (n += "next" === o ? r : -1 * r),
                    i.visibleSlidesIndexes && i.visibleSlidesIndexes.indexOf(n) < 0 && (i.params.centeredSlides ? n = n > l ? n - Math.floor(a / 2) + 1 : n + Math.floor(a / 2) - 1 : n > l && (n = n - a + 1),
                ...
                i.params.loop || i.params.virtual && i.params.virtual.enabled)
                    for (var v = 0; v < u; v += 1)
                        i.$wrapperEl.children('[data-swiper-slide-index="' + (t.realIndex + v) + '"]').addClass(c);
                else
                    for (var f = 0; f < u; f += 1)
